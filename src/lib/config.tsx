...
export const siteConfig = {
  ...
  links: {
    ...
    twitter: "https://twitter.com/arktisai",
    discord: "https://discord.gg/arktisai",
    github: "https://github.com/arktisai",
    instagram: "https://instagram.com/arktisai",
  },
  hero: {
    title: "Arktis AI",
    description:
  ...
  footer: {
    socialLinks: [
      {
        ...
        url: "https://github.com/arktisai",
      },
      {
        icon: <Icons.twitter className="h-5 w-5" />,
        url: "https://twitter.com/arktisai",
      },
    ],
    links: [
      { text: "Tjenester", url: "#" },
    ...
    bottomText: "Alle rettigheter reservert.",
    brandText: "ARKTIS AI",
  },
